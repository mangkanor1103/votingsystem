...
<body class="hold-transition skin-green sidebar-mini"> <!-- Apply green theme -->
<div class="wrapper">
    ...
    $(function(){
      ...
      var barChartData = {
        ...
        datasets: [
          {
            label               : 'Votes',
            backgroundColor     : 'rgba(60,179,113,0.9)', // Change fill color to green shade
            borderColor         : 'rgba(60,179,113,0.8)', // Change border color to green shade
            pointBackgroundColor: '#3cb371', // Change point color to a different green shade
            pointBorderColor    : 'rgba(60,179,113,1)', // Change point border color to green shade
